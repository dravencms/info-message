...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'infoMessage' => [
                'edit' => 'Umožnuje editaci Info message',
                'delete' => 'Umožnuje smazání Info message'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\InfoMessage\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}